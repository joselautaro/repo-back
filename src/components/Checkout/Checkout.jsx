...
export const Checkout = () => {
    ...
    const handleSubmit = (e) => {
        ...
        const orden = {
            ...
            // Timestamp nos sirve para crear un tipo de fecha y los formateamos con el metodo new Date de JavaScript Vanilla
        ...
        // Actualiamos la cantidad en la base de datos
